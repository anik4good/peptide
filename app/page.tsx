  ...
  return (
    <>
      ...
      <div className="legend-bar">
        <div
          className={`legend-item ${selectedCategory === 'All' ? 'active' : ''}`}
          onClick={() => setSelectedCategory('All')}
        >
          <div className="ldot" style={{ background: '#fff' }}></div>
          All
        </div>
        <div
          className={`legend-item ${selectedCategory === 'GH-Axis' ? 'active' : ''}`}
          onClick={() => setSelectedCategory('GH-Axis')}
        >
          <div className="ldot" style={{ background: 'var(--g0)' }}></div>
          GH / IGF
        </div>
        <div
          className={`legend-item ${selectedCategory === 'Healing' ? 'active' : ''}`}
          onClick={() => setSelectedCategory('Healing')}
        >
          <div className="ldot" style={{ background: 'var(--g2)' }}></div>
          Healing
        </div>
        <div
          className={`legend-item ${selectedCategory === 'Fat-Loss' ? 'active' : ''}`}
          onClick={() => setSelectedCategory('Fat-Loss')}
        >
          <div className="ldot" style={{ background: 'var(--g5)' }}></div>
          Fat Loss
        </div>
        <div
          className={`legend-item ${selectedCategory === 'Neuro' ? 'active' : ''}`}
          onClick={() => setSelectedCategory('Neuro')}
        >
          <div className="ldot" style={{ background: 'var(--g4)' }}></div>
          Neuro
        </div>
        <div
          className={`legend-item ${selectedCategory === 'Longevity' ? 'active' : ''}`}
          onClick={() => setSelectedCategory('Longevity')}
        >
          <div className="ldot" style={{ background: 'var(--g6)' }}></div>
          Longevity
        </div>
        <div
          className={`legend-item ${selectedCategory === 'Misc' ? 'active' : ''}`}
          onClick={() => setSelectedCategory('Misc')}
        >
          <div className="ldot" style={{ background: 'var(--g1)' }}></div>
          Sexual / Other
        </div>
      </div>
